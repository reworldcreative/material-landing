      ...
      rollupOptions: {
        output: {
          ...
          manualChunks: {
            ...
            // ],
            // muiFileLoaderDropzone: ["@mui/material/InputLabel", "@mui/material/OutlinedInput"],
            // muiTheme: ["@mui/material/styles/createTheme", "@mui/material/styles/responsiveFontSizes"],
